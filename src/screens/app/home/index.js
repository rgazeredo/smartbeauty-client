        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <View style={styles.tab}>
                    ...
                    <Text style={styles.tabsactive}>PROFISSIONAIS</Text>
                ...
                <View style={styles.tab1}>
                    ...
                    <TouchableOpacity style={styles.tab2} onPress={() => this.props.navigator.push({ screen:'app.professional' })}>
                        <Image
